...
class ImageGalary extends Component {
  ...
  render() {
    ...
    //console.log("lignghbox img url",imageDetails)
  ...
  //   ];
        ...
        // var = '<table cellSpacing="20">' 
        //   <tr> 
        //     <td style={{textAlign:"center"}}>Front POI <img style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(0)}   src={images[0]}/>  </td> 
        //     <td style={{textAlign:"center"}}>Back POI<img style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(1)}  src={images[1]}/>  </td> 
        //   </tr> 
        //   <tr> 
        //     <td style={{textAlign:"center"}}>Signature POI<img style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(2)}  src={images[2]}/>  </td> 
        //     <td style={{textAlign:"center"}}>PEF Image <img  style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(3)}  src={images[3]}/> 
        //  </td> 
        //   </tr> 
        // </table>
 ...
 */}
        ...
        <table cellSpacing="20"> 
          ...
          <tr> 
            <td style={{textAlign:"center"}}>Signature POI<img style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(2)}  src={images[2]}/>  </td> 
            <td style={{textAlign:"center"}}>PEF Image <img  style={styles.imageFormat} width="250" height="200"  onClick={() => this.openImageGalary(3)}  src={images[3]}/> </td> 
          </tr> 
        </table>
