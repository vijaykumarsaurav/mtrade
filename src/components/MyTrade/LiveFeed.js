...
class Home extends React.Component{
    constructor(props) {
        ...
        this.state = {
            userName: "",
            password: "",
            autoSearchList :[{"token":"11536","symbol":"TCS-EQ","name":"TCS","expiry":"","strike":"-1.000000","lotsize":"1","instrumenttype":"","exch_seg":"NSE","tick_size":"5.000000"},{"token":"532540","symbol":"TCS","name":"TCS","expiry":"","strike":"-1.000000","lotsize":"1","instrumenttype":"","exch_seg":"BSE","tick_size":"5.000000"}],
            isDasable:false,
            isError:false,
            InstrumentLTP : {},
            ifNotBought : true,
    ...
    componentDidMount() {
        ...
        wsClint.onmessage = (message) => {
            ...
            var data = this._atos(pako.inflate(decoded));
  ...
  //      this.setState({ tradingsymbol :  this.state.symbolList[0].symbol, symboltoken : this.state.symbolList[0].token});
    ...
    //     AdminService.saveWatchList(fdata).then(res => {
    //         let data =  res.data ; 
    //         console.log(data);  
    //         //let data = resolveResponse(res, 'noPop');
    //    })
